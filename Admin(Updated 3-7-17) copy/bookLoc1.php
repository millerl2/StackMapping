...
<html lang = "en">
	...
	<body>
		<header>
        <img src="/newpage/images/stllogowhite.png" height="200%" style="margin-top:1px;position:relative;top:-10px" alt="">
        <h1> View and Edit Shelf Locations </h1>
    	</header>

		<div id = "container">
		<button type = "button" onClick = "add()">Add Record</button><br>
	<?php
		include ("connect.php");
		...
		$conn->close();
	?>
		<br><button type = "button" onClick = "add()">Add Record</button><br>
		</div>	 		 
	</body>
</html>